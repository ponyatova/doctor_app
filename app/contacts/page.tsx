                    ...
                    <RevealSection animation="fade-up">
                        <div className="text-center max-w-3xl mx-auto">
                            ...
                            <p className="text-lg md:text-xl text-slate-500 mb-8 leading-relaxed">
                                Запишитесь на приём или задайте интересующий вопрос.
                                ...
                                {phoneContact && (
                                    ...
                                    >
                                        ...
                                        <div className="text-left">
                                            ...
                                            <div className="text-sm font-medium text-slate-700">{phoneContact.value}</div>
                                        </div>
                                    </a>
                                )}
                                ...
                                {emailContact && (
                                    ...
                                    >
                                        ...
                                        <div className="text-left">
                                            ...
                                            <div className="text-sm font-medium text-slate-700">{emailContact.value}</div>
                                        </div>
                                    </a>
                                )}
                            </div>
